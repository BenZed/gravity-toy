...
var Simulation = function (_EventEmitter) {
  ...
  function Simulation() {
    ...
    var G = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
  ...
  (0, _createClass3.default)(Simulation, [{
    ...
    value: function value(body) {
      ...
      var vcf = body.vel.magnitude / body.collisionRadius;
      ...
      while (interval.bodySubIndex < bodies.length) {
        ...
        for (var i = 0; i < collisionPoints.length; i++) {
          ...
          //ta daaaa
          if (collisionRadiusSqr + Math.pow(otherBody.collisionRadius, 2) > distSqr) {
