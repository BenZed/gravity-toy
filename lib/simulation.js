...
var Simulation = function (_EventEmitter) {
  ...
  (0, _createClass3.default)(Simulation, [{
    ...
    value: function value(body) {
      ...
      var normal = _vector2.default.zero;
      ...
      while (interval.bodySubIndex < bodies.length) {
        ...
        var otherRadius = otherBody.collisionRadius;
        ...
        if (dist < body.collisionRadius + otherRadius) this[_collide](body, otherBody);
