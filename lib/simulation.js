...
var UPDATE_SLACK = 10;
var MAX_CACHE_SIZE = 33 * 60 * 30; // 10 minutes, assuming the default UpdateDelta
...
var Simulation = function (_EventEmitter) {
  ...
  (0, _createClass3.default)(Simulation, [{
    ...
    value: function value() {
      ...
      if (!this[_paused] && this[_bodies].length > 0 && interval.currentTick < MAX_CACHE_SIZE) while (!interval.check()) {
        this[_integrate]();
      }for (var i = 0; i < bodies.length; i++) {
